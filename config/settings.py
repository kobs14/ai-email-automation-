...
class AppSettings:
    ...
    response_approval_mode: str = field(default_factory=lambda: os.getenv("RESPONSE_APPROVAL_MODE", "manual"))
...
class TelegramSettings:
    ...
    def is_configured(self) -> bool:
        ...
        return bool(self.bot_token and self.bot_token != "your_bot_token_from_botfather" and self.admin_chat_id)
...
class CalendarSettings:
    ...
    enabled: bool = field(default_factory=lambda: os.getenv("CALENDAR_ENABLED", "false").lower() == "true")
    calendar_id: str = field(default_factory=lambda: os.getenv("GOOGLE_CALENDAR_ID", "primary"))
    default_duration_hours: float = field(default_factory=lambda: float(os.getenv("CALENDAR_DEFAULT_DURATION", "3.0")))
    buffer_minutes: int = field(default_factory=lambda: int(os.getenv("CALENDAR_BUFFER_MINUTES", "30")))
    timezone: str = field(default_factory=lambda: os.getenv("CALENDAR_TIMEZONE", "America/New_York"))
...
class CRMSettings:
    ...
    enabled: bool = field(default_factory=lambda: os.getenv("CRM_ENABLED", "false").lower() == "true")
    provider: str = field(default_factory=lambda: os.getenv("CRM_PROVIDER", "null"))
    api_key: str = field(default_factory=lambda: os.getenv("CRM_API_KEY", ""))
    api_url: str = field(default_factory=lambda: os.getenv("CRM_API_URL", ""))
    sync_enabled: bool = field(default_factory=lambda: os.getenv("CRM_SYNC_ENABLED", "false").lower() == "true")
    log_interactions: bool = field(default_factory=lambda: os.getenv("CRM_LOG_INTERACTIONS", "true").lower() == "true")
