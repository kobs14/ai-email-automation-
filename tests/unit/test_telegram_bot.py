...
class TestBotCreation:
    ...
    @patch("services.telegram.bot.settings")
    def test_create_application_with_valid_token(self, mock_settings, mock_application):
...
class TestNotifications:
    ...
    def test_notify_new_draft_success(self, mock_send, mock_db):
        ...
        with patch("database.schema.ResponseRepository", return_value=mock_response_repo):
